function calculateHours() {
    ...
    if (totalHours*60 >= requiredHours*60) {
        ...
        resultDiv.innerHTML += `¡Estas al horno!, te faltan ${Math.trunc(remainingHours_hs/60)-1} hs y ${Math.trunc(remainingHours_min)+60} min para cumplir con ${Math.trunc(requiredHours)} horas diarias<br>`;
    }
}
