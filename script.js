function calculateHours() {
    ...
    if (totalHours*60 >= requiredHours*60) {
        ...
        resultDiv.innerHTML += `¡Estas al horno!, te faltan ${Math.trunc(remainingHours_hs/60)} hs y ${Math.trunc(remainingHours_min)} min para cumplir con ${Math.trunc(requiredHours)} horas diarias<br>`;
    }
}
