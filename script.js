function calculateHours() {
    ...
    if (totalHours*60 >= requiredHours*60) {
        ...
        resultDiv.innerHTML += `¡Estas al horno!, te faltan ${(remainingHours_hs/60).toFixed(0)} hs y ${remainingHours_min-(remainingHours_hs/60).toFixed(0)*60} min para cumplir con ${requiredHours} horas diarias<br>`;
    }
}
